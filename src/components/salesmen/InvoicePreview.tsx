...
export function InvoicePreview({
  ...
  const content = (
    <div className="flex h-full min-h-0 flex-col">
      ...
      <div className="flex-1 overflow-y-auto bg-[#f0efeb] p-4 sm:p-6 print:bg-white print:p-0">
        <div
          ...
          <div className="mt-5 flex flex-col gap-4 sm:flex-row sm:justify-between">
            ...
            <div className="min-w-[10rem] space-y-1.5 text-sm">
              ...
              <div className="flex items-center justify-between border-t border-border pt-2 font-medium">
                <span>Balance</span>
                <span className={balance > 0 ? "text-[#c45c26]" : undefined}>
                  {formatINR(balance)}
                </span>
              </div>
            </div>
  ...
  return (
    <div className="flex h-full min-h-[28rem] flex-col overflow-hidden rounded-xl border border-border bg-surface">
      {content}
    </div>
  );
}
